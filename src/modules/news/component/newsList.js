...
const getNewsListUrl = restUrl.BASE_HOST + 'News/getNewsList';
const delNewsUrl = restUrl.BASE_HOST + 'News/delNews';
...
class NewsList extends React.Component {
    ...
    delNews = id => {
        ...
        ajax.postJSON(delNewsUrl, JSON.stringify(param), (data) => {
            if(data.success){
                notification.open({
                    message: '删除新闻成功！',
