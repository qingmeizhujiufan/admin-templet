                                ...
                                <ul className="unstyled inline brands">
                                    {
                                        selectStructuralSectionOptions.map((item, index) => {
                                            return <li key={index}>
                                                <span>{item.name}</span>
                                                <span className="del" onClick={() => this.delBrand(item, 1)}><Icon
                                                    type="close-square"/></span>
                                            </li>
                                        })
                                    }
                                </ul>
                                ...
                                <ul className="unstyled inline brands">
                                    {
                                        selectHardwareOptions.map((item, index) => {
                                            return <li key={index}>
                                                <span>{item.name}</span>
                                                <span className="del" onClick={() => this.delBrand(item, 2)}><Icon
                                                    type="close-square"/></span>
                                            </li>
                                        })
                                    }
                                ...
                                <ul className="unstyled inline brands">
                                    {
                                        selectSealantOptions.map((item, index) => {
                                            return <li key={index}>
                                                <span>{item.name}</span>
                                                <span className="del" onClick={() => this.delBrand(item, 3)}><Icon
                                                    type="close-square"/></span>
                                            </li>
                                        })
                                    }
